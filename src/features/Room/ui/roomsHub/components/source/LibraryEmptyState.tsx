...
const LibraryEmptyState = ({
  ...
  <div className="flex h-full min-h-0 flex-col justify-center rounded-2xl border border-white/8 bg-[linear-gradient(180deg,rgba(2,6,23,0.46),rgba(15,23,42,0.28))] px-5 py-8 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
